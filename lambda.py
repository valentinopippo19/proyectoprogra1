...
def menu():
    ...
    metadatos = [
        ["ID001", "Final", "Fundamentos de Programación", "8"],
        ["ID002", "Final", "Fundamentos de Programación", "10"],
        ["ID003", "Final", "Fundamentos de Programación", "7"],
        ["ID004", "Final", "Fundamentos de Programación", "9"],
        ["ID005", "Final", "Fundamentos de Programación", "6"]
    ]
